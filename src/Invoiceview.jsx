    ...
    <div className="w-full p-6 flex flex-col items-center bg-gray-100 min-h-screen">
      <div className="w-full max-w-4xl bg-white shadow-xl rounded-2xl p-8">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">Generated from your orders</p>
        </div>
        ...
        {!loading && !error && items.length > 0 && (
          <>
            ...
            <Card className="p-5 mt-8 text-lg rounded-2xl shadow-md">
              ...
              <p className="text-xl font-bold">Total Amount:<span className="text-green-700 ml-2">Rs{totalAmount}</span></p>
            </Card>
          </>
        )}
      </div>
